...
Gem::Specification.new do |spec|
  ...
  spec.description = "Generates simple fantasy characters using clear Ruby classes, composition, and YAML-backed catalogs."
  spec.license = "MIT"
  ...
  spec.files = Dir.glob("lib/**/*.{rb,yml}") + ["README.md"]
  spec.bindir = "bin"
